...
export default function GoogleButton() {
    return (
        <>
            <button onClick={()=> signIn('google')} className="w-full h-[12cqw] text-[4cqw] rounded-[3cqw] bg-zinc-800 px-[5cqw] py-[3cqw] font-semibold flex flex-row justify-center text-center item-center transition-all duration-300 hover:bg-zinc-200 hover:text-zinc-800 group ">
